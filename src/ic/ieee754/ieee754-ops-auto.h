...
_TME_RCSID("$Id: ieee754-ops-auto.sh,v 1.4 2007/02/21 01:49:01 fredette Exp $");
...
struct tme_ieee754_ops {
  ...
  void (*tme_ieee754_ops_single_to_int64) _TME_P((struct tme_ieee754_ctl *, _tme_const struct tme_float *, struct tme_float *));
  ...
  void (*tme_ieee754_ops_double_to_int64) _TME_P((struct tme_ieee754_ctl *, _tme_const struct tme_float *, struct tme_float *));
  ...
  void (*tme_ieee754_ops_extended80_to_int64) _TME_P((struct tme_ieee754_ctl *, _tme_const struct tme_float *, struct tme_float *));
  ...
  void (*tme_ieee754_ops_quad_to_int64) _TME_P((struct tme_ieee754_ctl *, _tme_const struct tme_float *, struct tme_float *));
};
